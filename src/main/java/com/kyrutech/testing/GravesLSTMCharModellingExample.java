...
public class GravesLSTMCharModellingExample {
    ...
    public static void main( String[] args ) throws Exception {
        ...
        File savedNetwork = new File("SavedRNN.zip");
    ...
    public static CharacterIterator getTimeCubeIterator(int miniBatchSize, int sequenceLength) throws Exception {
        File f = new File("./src/main/resources/timecube.txt");
